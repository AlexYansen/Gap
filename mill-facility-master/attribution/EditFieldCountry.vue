<template>
  ...
  <div class="content" style="padding-left: 20px;padding-right: 20px">
    <div class="row">
      <div class="col-md-12">
        <div>
          <label class="field-title">Country of Origin</label>
        </div>
        <div>
            <multi-select :options="countries" v-model="country" :filter="true" id-field="code" label-field="name" :is-multiple="false" />
        </div>
        <br/>
        <br/>
        <div>
